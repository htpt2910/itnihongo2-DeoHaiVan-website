...
def Seed_db(SessionLocal):
    ...
    user1.hashed_password = '$2b$12$yEFIqnGqRN75auPvA9qZ7Oo6L6Y6oNF9GxPdSghr.9EyJD6gAF/ce'
    ...
    user2.hashed_password = '$2b$12$yEFIqnGqRN75auPvA9qZ7Oo6L6Y6oNF9GxPdSghr.9EyJD6gAF/ce'
